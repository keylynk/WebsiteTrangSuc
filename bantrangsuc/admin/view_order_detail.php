                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="color: blue;">
                                    ...
                                    <?php 
                                        ...
                                        if($order_status == 'Pending') {
                                            ...
                                            echo $order_status = "<span style='color:#FF1D36; font-size: 18px'>Chờ xử lý đơn hàng</span>";
                                            
                                        } else if ($order_status == 'Delivering') {
                                          echo $order_status =  "<span style='color:#545158; font-size: 18px'>Đang giao hàng</span>";
                                        }
                                        else if ($order_status == 'Delivered') {
                                          echo $order_status = "<span style='color:#00CC07; font-size: 18px'>Đã giao hàng thành công</span>";
                                        } else {
                                            
                                            echo $order_status = "<span style='color:#0088cc; font-size: 18px'>Đã xác nhận thanh toán</span>";
                                ...
                                <td>
                                  <a href="index.php?confirm_yes=<?php echo $order_id; ?>&invoice_no=<?php echo $invoice_no; ?>" class="btn btn-primary btn-sm btn-confim"> Đã thanh toán</a>
                                  <a href="index.php?confirm_no=<?php echo $order_id; ?>&invoice_no=<?php echo $invoice_no; ?>" class="btn btn-primary btn-sm"> Chờ xử lý </a>
